...
class Topology:
    ...
    def generate_solutions(self, stop_early=False, discard_threshold=None, restart=1):
        ...
        print('symmetries:', self.symmetries)
...
if __name__ == '__main__':
    ...
    topology = Topology('lattice_cubic.dat', N=1, conjugacy=True, max_multiplicity=None)
    ...
    print('Port level solutions', topology.solutions)
    ...
    # topology.instantiate_strands_v1(5) # <- this might take a while to compute,
    ...
    # print(f"Number of strand-level permutations for solution 5: {len(topology.permuted_solutions[5])}")

    # Plot the first strand-level permutation for solution 5
    # topology.plot_solution_v1(solution=5, permutation=0)